...
public class JavaDocReaderTest {
    ...
    public void test() throws IOException {
        ...
        JavaDocVO javaDocVO = JavaDocReader.read(sourceDirectory, compilePathList);

        JSONArray array = new JSONArray(javaDocVO.getClassDocs().size());

        for (ClassDocVO value : javaDocVO.getClassDocs().values()) {
        ...
        for (ClassDocVO value : javaDocVO.getClassDocs().values()) {
            if ("org.genx.javadoc.controller.AppController".equals(value.getClassName())) {
                System.out.println(JSON.toJSONString(value));
            }

            if ("org.genx.javadoc.entity.User".equals(value.getClassName())) {
                System.out.println(JSON.toJSONString(value));
            }

            if ("org.genx.javadoc.field.ArticleQueryField".equals(value.getClassName())) {
                System.out.println(JSON.toJSONString(value));
            }
        }
...
//                .writeValueAsString(javaDocVO);
//        System.out.println(jsonString);

        System.out.println(" == 生成 RestApi 文档 == ");
    ...
    public void test2() throws IOException {
        ...
        for (ClassDoc classDoc : classDocs) {
            ...
            if (!"org.genx.javadoc.controller.AppController".equals(classDoc.qualifiedTypeName())) {
                continue;
            }
